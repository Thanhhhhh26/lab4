...
<head>
    ...
    <style>
        ...
        .note { background: #fff3cd; border-left: 4px solid #ffc107; padding: 12px 15px; border-radius: 4px; font-size: 13px; color: #666; margin-top: 20px; }
...
<body>
    <div class="container">
        ...
        <div class="body">
            ...
            <p>Chúng tôi nhận được yêu cầu đặt lại mật khẩu cho tài khoản của bạn tại <strong>Tin Tức Việt</strong>.</p>
